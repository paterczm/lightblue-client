...
import com.redhat.lightblue.client.http.transport.JavaNetHttpClientTest.CallConnectAndReturn;
import com.redhat.lightblue.client.request.LightblueRequest;

/**
 * Testing {@link JavaNetHttpClient}'s lzf compression support.
 *
 * @author mpatercz
 *
 */
@RunWith(JUnit4.class)
public class JavaNetHttpClientCompressionTest {

    private HttpURLConnection mockConnection = mock(HttpURLConnection.class);
    private JavaNetHttpClient.ConnectionFactory mockConnectionFactory = mock(JavaNetHttpClient.ConnectionFactory.class);
